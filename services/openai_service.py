...
async def ask_gpt(user_id: int, user_message: str, system_prompt: str = 'Ты полезный ассистент.Отвечай кратко и по делу и вежливо', history_from_fsm: list=None) -> str:
    try:
